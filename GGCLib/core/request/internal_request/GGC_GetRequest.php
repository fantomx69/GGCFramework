<?php
/**
 * Description of GGC_GetInternalRequestProvider
 *
 * @author Gianni
 */
class GGC_GetRequest extends GGC_InternalRequest {
    ...
    static function create($instanceName, $objRequestFrom, $uri = NULL,
        ...
        if (!empty($errMsg)) {
            ...
            $result = new GGC_GetRequest($objRequestFrom, $uri, $aryRequestFields);
